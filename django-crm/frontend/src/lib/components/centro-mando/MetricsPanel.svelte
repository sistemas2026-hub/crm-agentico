...
<style>
  ...
  .cifras { display: grid; grid-template-columns: repeat(auto-fit, minmax(146px, 1fr)); border-bottom: 1px solid rgba(0,229,255,.14); }
  .cifra { padding: 12px 16px; border-right: 1px solid rgba(0,229,255,.14); }
  .cifra:last-child { border-right: 0; }
  .v { font-family: ui-monospace, monospace; font-size: 22px; font-weight: 700; line-height: 1; color: #e6f1ff; }
  .k { font-size: 10px; letter-spacing: .1em; color: #8aa2c0; text-transform: uppercase; margin-top: 6px; }
