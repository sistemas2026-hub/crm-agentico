...
| **G8** | [G8-LEGADO-WHATSAPP.md](G8-LEGADO-WHATSAPP.md) | **ROJO** | Herramienta de revision lista y probada, sin PII y sin escrituras. Las 16 reales NO se revisaron: viven en produccion y la decision es de una persona, no de la IA. Sin G8 no hay corte de control. |
