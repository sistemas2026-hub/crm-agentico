...
**Modelo documental: lo que se decidió NO hacer todavía (22/08/2026).** Al agregar la aprobación de documentos y el guardado del archivo original (`supabase/22` y `23`) se evaluó un modelo más completo y se dejó afuera a propósito. Queda anotado para cuando aparezca la presión que lo justifique, y con el motivo por el que hoy no se hizo:
